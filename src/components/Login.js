    ...
    <>
      <div className='login-page' >
        <div className='login-form'>
            ...
            <button type="submit" style={{marginTop:"40px",marginBottom:"15px",margin:"auto",borderRadius:"5px",width:"100px",backgroundColor:"blue",color:"white",border:"0",height:'40px'}}>LOGIN</button>
        </div>
      </div>
    </>
  )

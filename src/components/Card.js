    ...
    return (
        <div className="card">
            <section className="section-left">
                <h5 className="card-title" color="rgb(20, 69, 206)">{item.name ?? item.firstName}</h5>
                <section className="email" display="flex" align-items="center">
                    <img src={email} alt="email" width="15px" height="15px" margin="0px" />
                ...
                <section className="btn " padding="0px" >
                    ...
                    <button type="button" style={{marginLeft:"6px"}}  onClick={isDeleted} className="btn btn-danger">Delete</button>
                    <button type="button" style={{marginLeft:"6px",color:"white"}}  onClick={onDetails} className="btn btn-warning">Details</button>
                </section>
            </section>
            <section className="section-right" text-align='center'>
                <button type="button" className="btn btn-success"
                    color="white" padding="3px 10px 3px 10px"  >Professional</button>
                <br />
